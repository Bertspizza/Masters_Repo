"""
Utilities for False Nearest Neighbors (FNN) analysis.

Functions:
    - fnn: Perform FNN analysis on a time series.
    - plot_fnn: Plot the results of FNN analysis.
    - embed_time_series: Embed a time series based on given dimension and lag.
...
def fnn(timeseries, tlag, min_dimension, max_dimension):
    ...
    tlag : int
        The time lag obtained from the AMI.
    min_dimension : int
...
def plot_fnn(dimensions, fnn_percentages, header='FNN'):
    plt.figure()
